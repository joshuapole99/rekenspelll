...
score_text.innerHTML = "score:" + "<br>" + score;
level_text.innerHTML = " level :" + "<br>" + level;
...
function getProblem(){
    ...
    switch (level) {
        ...
        case 2:
            ...
            ans = first_Number + "*" + "X" + "= " + second_Number + ". Wat is X?";
            break;
        case 3:
